Name:
    Gentium - Gentium & GentiumAlt
Description:
    A TrueType font from Debian.
Source:
    Debian package (x11/ttf-gentium)
License:     
       ( From http://packages.debian.org/changelogs/pool/main/t/ttf-gentium/  )
       (             ttf-gentium_1.02-2/ttf-gentium.copyright                 )
