...
Source:
    Debian package (x11/ttf-thai-tlwg)
License:     
  (From http://packages.debian.org/changelogs/pool/main/t/thaifonts-scalable/ )
  (            thaifonts-scalable_0.4.6-1/ttf-thai-tlwg.copyright             )
