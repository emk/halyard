...
;;;     (dolist lambda) (no-errors lambda) (regexper lambda) (generic lambda)
;;;     (defgeneric define) (method lambda) (named-method lambda)
;;;     (qualified-method lambda) (defmethod define) (beforemethod lambda)
;;;     (aftermethod lambda) (aroundmethod lambda) (defbeforemethod define)
;;;     (defaftermethod define) (defaroundmethod define) (class lambda)
;;;     (entityclass lambda) (defclass define) (defentityclass define)
;;;     (defgeneric* define) (defclass* define) (defentityclass* define)
;;;     (with-slots lambda) (with-accessors lambda) (matcher lambda)
;;;     (match lambda) (defmatcher define) (defmatcher0 define)))
