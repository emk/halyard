...
namespace Typography {
	...
	public:
		...
		/// specified character.
		///
		/// \param inCharCode  The character whose face we want to find.
		/// \return  The face associated with that character.
	...
	private:
		...
		///
		/// \param inCharCode  The character we want to find.
		/// \param outFace  (out) A face with an appropriate glyph.
		/// \param outGlyphIndex  (out) The index of the glyph in that face.
	...
	protected:
		...
		/// 
		/// \param inPrevious  The previous segment (for kerning), or NULL.
		...
		/// 
		/// \param ioRemaining  (in/out) On input, the segment from which to
	...
	public:
		...
		/// \param inJustification  The desired justification.
	...
	public:
		...
		/// \param inStyle  The style.  May be kRegularFaceStyle,
