...
public:
    ...
    typedef boost::unordered_map<std::string, Entry> LowercaseFilenameMap;
    ...
    const LowercaseFilenameMap &LowercaseFilenameEntryMap() const { 
        return mLowercaseFilenameMap;
    }

private: 
    EntrySet mEntries;
    DigestSet mDigests;
    LowercaseFilenameMap mLowercaseFilenameMap;
