...
BEGIN_EVENT_TABLE(DocNotebook, wxWindow)
    ...
    EVT_MENU(HALYARD_SAVE_ALL, DocNotebook::OnSaveAll)
    EVT_UPDATE_UI(HALYARD_SAVE_ALL, DocNotebook::OnUpdateUiSaveAll)
    EVT_MENU(HALYARD_CLOSE_TAB, DocNotebook::OnCloseTab)
    EVT_UPDATE_UI(HALYARD_CLOSE_TAB, DocNotebook::OnUpdateUiCloseTab)
END_EVENT_TABLE()
